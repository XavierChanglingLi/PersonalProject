/*
*Author: Bruce A. Maxwell, Stephanie R Taylor & Changling Li
*Date: 11/28/19
*Name: InteractiveLandscapeDisplay.java
*/
...
public class InteractiveLandscapeDisplay {
    ...
    public InteractiveLandscapeDisplay() {
        ...
        v2.connect( v1, Direction.WEST );
        v2.connect( v3, Direction.EAST );
        v3.connect( v2, Direction.WEST );
        v3.connect( v4, Direction.EAST );
        v4.connect( v3, Direction.WEST );
