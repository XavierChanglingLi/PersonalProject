/**
*Author: srtaylor, bmaxwell & Changling Li
*Date: 10/26/19
*Name: MapSet.java
*Interface for a data structure that maps a key to a value, like a Python dictionary would.  This is a subset of the Java Map interface.
*/
